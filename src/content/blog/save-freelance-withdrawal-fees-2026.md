...
1. **Service Fees**: The platform's cut (Upwork, Fiverr, etc.).
2. **Transfer Fees**: Fixed costs to move money (e.g., $2 for Payoneer, $0.99 for Local Bank).
3. **Hidden Spread**: This is the difference between the "Google Interbank Rate" and the "Bank Buying Rate." 
...
The best strategy is to avoid "convenience" and look at the math. Our [Freelance Fee & Arbitrage Optimizer](/calculators/freelance-fee-optimizer) allows you to simulate your exact contract and see the "Total Leakage" across different paths.
