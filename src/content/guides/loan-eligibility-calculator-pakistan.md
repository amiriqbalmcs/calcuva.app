...
faqs:
  - q: "What is the minimum salary for a bank loan in Pakistan?"
    a: "Most commercial banks (HBL, UBL, Alfalah) require a minimum net monthly salary of PKR 35,000 for salaried individuals. For self-employed individuals, this threshold is often higher (PKR 50,000+)."
  - q: "What is the DTI (Debt-to-Income) ratio?"
    a: "The DTI ratio is the percentage of your monthly income that goes toward paying debts. Per SBP regulations, your total monthly debt payments (including the new loan) generally shouldn't exceed 40-50% for car loans and 65% for housing."
  - q: "Can I combine my spouse's income for a higher loan?"
    a: "Yes. Most banks allow 'Co-borrowing' where you can club the income of your spouse, parents, or children to increase your total eligibility and get a larger loan amount."
  - q: "What is KIBOR and how does it affect my loan?"
    a: "KIBOR (Karachi Interbank Offered Rate) is the base interest rate. Most loans are 'KIBOR + Spread' (e.g., 1-year KIBOR + 3%). If KIBOR rises, your monthly EMI will likely increase during the annual review."
