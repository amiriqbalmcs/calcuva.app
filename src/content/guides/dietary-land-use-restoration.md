...
faqs:
  - q: "Is 'Lab-Grown Meat' better for the land?"
    a: "Absolutely. 2026 benchmarks show that cultivated meat (lab-grown) uses 95% less land than traditional livestock. By producing meat in bioreactors rather than requiring vast grazing lands, we can significantly reduce the pressure on global forests, though the energy footprint for these facilities is still a work in progress."
  - q: "Why is land-use more important than carbon?"
    a: "Because land is a finite resource. While we can transition to renewable energy sources to solve the carbon crisis, we cannot 'generate' more surface area for the Earth. Protecting land from agricultural expansion is the primary way to protect biodiversity and prevent the 6th mass extinction."
  - q: "Can shifting from beef to poultry help?"
    a: "Yes. Poultry (chicken) requires roughly 10x less land than beef to produce the same amount of protein. While plant-based proteins remain the gold standard for land efficiency, shifting from ruminant meats (beef, lamb) to poultry is one of the most effective 'middle-ground' sustainability moves a consumer can make in 2026."
  - q: "What is 'Rewilding' and how does my diet affect it?"
    a: "Rewilding is the process of restoring an area of land to its natural uncultivated state. Because livestock farming occupies nearly 80% of global agricultural land while providing only 20% of calories, reducing meat consumption is the single most effective way to 'release' land for rewilding projects."
  - q: "Does the calculator take into account 'Food Miles'?"
    a: "Yes. In 2026, our algorithm includes the 'Logistics Land Footprint'—the land used for roads, warehouses, and distribution centers required to bring imported food to your table. Choosing local, seasonal produce reduces this hidden land-use cost."
