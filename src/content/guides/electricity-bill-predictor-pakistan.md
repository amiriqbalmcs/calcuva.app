...
faqs:
  - q: "What is the 'Protected Category' in Pakistan's electricity bills?"
    a: "Protected consumers are residential users whose monthly consumption has remained below 200 units for the last 6 consecutive months. They enjoy a subsidized base rate. If you cross 200 units in a single month, you risk losing this status for the next six months."
  - q: "How much is GST on electricity bills in 2026?"
    a: "The General Sales Tax (GST) is currently 18%. It is calculated on the subtotal of your variable charges, fixed charges, and surcharges. It is one of the largest non-energy components of your bill."
  - q: "What is Fuel Price Adjustment (FPA)?"
    a: "FPA is a monthly charge notified by NEPRA to account for the difference in the actual fuel cost for power generation versus the 'Reference Fuel Cost.' In 2026, this remains a volatile component depending on global energy markets."
  - q: "What are the 'Peak' and 'Off-Peak' hours for 2026?"
    a: "For consumers with 3-phase 'Time-of-Use' (ToU) meters, peak hours are typically from 6:00 PM to 10:00 PM (this can vary by an hour depending on the season). During these hours, the unit rate is significantly higher, sometimes double the off-peak rate."
...
1.  **Stay Under 200**: If you are at 190 units on the 25th of the month, switch to fans only. Staying under 200 units can save you significantly more than the "convenience" of those 10 units is worth.
2.  **Monitor the FPA Notifications**: Follow NEPRA's monthly hearings. If a high FPA is announced, try to reduce your consumption in that specific billing cycle.
3.  **Check for "Faulty Metering"**: If your bill shows a sudden spike without a change in lifestyle, use our [Unit Calculator] to verify if the units charged match your appliance wattage.
