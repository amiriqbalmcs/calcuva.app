...
faqs:
  - q: "What is the difference between Margin and Markup?"
    a: "Markup is a percentage added to the COST to find the sell price. Margin is the percentage of the SELL PRICE that is profit. A 100% markup only equals a 50% margin."
  - q: "What is Gross Profit Margin?"
    a: "Gross Margin = [(Revenue - Cost of Goods Sold) / Revenue] x 100. It shows the efficiency of your production or procurement before accounting for overhead."
  - q: "What is Net Profit Margin?"
    a: "Net Margin is the 'final' percentage left after ALL expenses (rent, salaries, taxes, marketing) are paid. It is the true measure of a business's sustainability."
  - q: "What is a 'Good' profit margin?"
    a: "It varies by industry. Retail typically sees 5-10% net margins, while SaaS (Software) and high-end consultancies often see 50-80% gross margins."
  - q: "How do I calculate a target sell price for a specific margin?"
    a: "Price = Cost / (1 - Target Margin %). Example for a 20% margin on a $100 item: $100 / 0.8 = $125."
...
*   **The Reality**: When they sell it for $75, their profit is $25. $25 divided by $75 is only **33.3% Margin**. 
By underestimating the math, they have missed their profit target by nearly 17%. Our [Profit Margin Tool] helps you avoid this trap by allowing you to work backwards from your desired margin to find the exact required sell price.
...
3. **Net Profit**: (Operating Profit - Taxes/Interest). This is what you actually keep as the owner.
Monitoring the "gap" between these three stages allows you to identify if your problem is high production costs (Gross) or bloated overhead (Operating).
...
*   **Tier 3 (Upsells)**: High-margin accessories (60-80%) where the real profit is made.
By using our calculator to model your "Average Order Value," you can balance thin-margin anchors with high-margin upsells to reach a sustainable 20% net profitability.
...
*   **Transaction Fees**: $2
Even if you sell the product for $20, you haven't made $10 profit—you have **lost $4 per sale**. Calcuva's [Profit Margin Calculator] forces you to account for these fractional costs to reveal your "Real Margin."
