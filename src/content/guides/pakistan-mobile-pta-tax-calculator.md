...
faqs:
  - q: "What is FBR Valuation Ruling No. 2070?"
    a: "Issued in April 2026, this ruling updated the customs value of 62 specific used mobile models to match current international market prices, affecting the total tax payable for DIRBS registration."
  - q: "Can I register my phone for free on a Passport?"
    a: "As of 2026, there is no 'free' slot. However, registering on a Passport offers a reduced rate on the 'Sales Tax' and 'Mobile Levy' components if the registration is initiated within 60 days of your international arrival."
  - q: "What happens if I don't pay the PTA tax?"
    a: "Your device's SIM functionality will be blocked by DIRBS after 60 days of its first use in Pakistan. You will still be able to use Wi-Fi, but local networks (4G/5G) will not work until the tax is cleared."
  - q: "Is the tax higher for Non-Filers in 2026?"
    a: "Yes. Under the Finance Act 2025-26, the 'Income Tax' component of the DIRBS registration is doubled for individuals who do not appear on the FBR's Active Taxpayers List (ATL)."
...
3.  **Generate PSID:** Visit the [DIRBS Portal](https://dirbs.pta.gov.pk/) or use the "Device Registration" app.
