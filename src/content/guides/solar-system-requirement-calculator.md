...
keywords: ["solar system sizing guide", "calculate solar kw need", "solar appliance load", "solar panel requirement pakistan"]
faqs:
  - q: "How much solar kW do I need for a 1.5 ton AC?"
    a: "A modern 1.5 ton inverter AC typically consumes 1.2kW to 1.6kW at peak load. To run it comfortably during the day along with other basic appliances (fridge, fans, lights), a 5kW solar system is the recommended baseline."
  - q: "What are Peak Sun Hours in Pakistan?"
    a: "Peak Sun Hours (PSH) represent the time the sun's intensity reaches an average of 1,000W/m². In Pakistan, this averages 5.2 to 5.6 hours per day, though it varies slightly between Karachi and Northern regions."
  - q: "How many solar panels are in a 10kW system?"
    a: "Using standard 2026 high-efficiency 580W-600W N-Type Bifacial panels, a 10kW system would require approximately 17 to 18 panels."
...
| Appliance | Typical Wattage | Usage Note |
| :--- | :--- | :--- |
| **Inverter AC (1.5 Ton)** | 1,400W | Stabilizes at ~600W after cooling |
| **Refrigerator (Inverter)** | 150W - 250W | Runs 24/7 with cycles |
| **BLDC Ceiling Fan** | 35W - 50W | 60% more efficient than old fans |
| **Water Pump (1 HP)** | 750W | High starting torque requirement |
| **LED Lights** | 12W - 18W | Negligible load, but adds up |
| **Electric Iron** | 1,000W - 2,000W | Heavy intermittent load |
...
### The Sizing Formula
To find your required system size (kW):
`System Size (kW) = Daily kWh Requirement / (PSH × Efficiency Factor)`

**Example**:
If you need **30 units (kWh)** per day in Lahore:
- `30 / (5.1 × 0.80) = 7.35 kW`
...
Use our [Solar System Requirement Calculator](/calculators/solar-system-requirement-calculator) to get a custom breakdown of your load and the recommended inverter size for your home.
