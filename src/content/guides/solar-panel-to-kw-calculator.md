...
faqs:
  - q: "How do I calculate total solar kW?"
    a: "Multiply the number of panels by the wattage per panel, then divide by 1000. Example: 10 panels of 550W = 5500W or 5.5kW."
  - q: "What is the standard solar panel wattage in 2026?"
    a: "The market standard has shifted toward high-efficiency N-Type TopCon panels, typically ranging from 550W to 600W for residential use."
...
| System Size | Number of Panels (580W) | Approx. Area (Sq Ft) |
|-------------|-------------------------|----------------------|
| 3.48 kW     | 6                       | 150 - 160            |
| 5.80 kW     | 10                      | 250 - 270            |
| 11.6 kW     | 20                      | 520 - 550            |
...
**Q: Can I mix panels of different wattages?**
**A:** It is not recommended. If you mix a 550W panel with a 580W panel on the same string, the inverter will usually "throttle" the entire string to the current of the weakest panel, wasting the extra capacity of the 580W panels.

**Q: What happens if my solar kW is higher than my inverter kW?**
**A:** This is called "Over-clocking" or "DC-to-AC Ratio." Most modern inverters can handle up to 130% of their rated capacity (e.g., 6.5kW of panels on a 5kW inverter). The inverter will "Clip" the excess power at midday but generate more power during the morning and evening.

**Q: How do I know if my panels are original Tier-1?**
**A:** In 2026, you should verify the serial number via the manufacturer's official app. Many "B-Grade" panels are sold with fake 580W stickers. If the math in our calculator doesn't match your generation even on a clear day, your panels might be under-performing.
