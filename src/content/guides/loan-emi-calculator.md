...
faqs:
  - q: "What is an Equated Monthly Installment (EMI)?"
    a: "An EMI is a fixed payment amount made by a borrower to a lender at a specified date each calendar month. EMIs are applied to both interest and principal each month, so that over a specified number of years, the loan is paid off in full."
...
Most Tier-1 banks worldwide use the **Reducing Balance Method**. Unlike "Flat Rate" loans, where interest is charged on the original principal for the entire duration, the reducing method rewards you for every dollar you pay back. As your principal shrinks, so does the interest "tax" on your wealth. 

#### Expert Case Study: The Power of 1%
Consider a $250,000 loan at 7% for 20 years. 
*   **Monthly EMI**: $1,938
*   **Total Interest**: $215,221

If you increase your EMI by just **$200 a month** (~10%), you don't just finish the loan faster; you save nearly **$45,000 in interest** and shave 4 years off the tenure. This is the "Debt Snowball" in action.

#### Technical Breakdown: The Amortization Formula
Calcuva calculates your EMI using the standard international formula:
