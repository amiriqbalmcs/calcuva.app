...
import {
  ...
  Sparkles, Globe, Landmark, Copy, FileText, Award, AlertCircle
} from "lucide-react";
    ...
    <CalculatorPage calc={calc} guideHtml={guideHtml} faqs={faqs} relatedArticles={relatedArticles}>
      <div className="grid lg:grid-cols-12 gap-8 items-start max-w-6xl mx-auto">
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="surface-card p-8 bg-background border-border/60 shadow-md relative overflow-hidden group">
             <div className="absolute top-0 right-0 p-4">
                <button 
                  ...
                  className={cn(
                    ...
                    copied ? "bg-foreground text-background" : "hover:bg-secondary text-muted-foreground hover:text-foreground"
                  )}
                >
                  {copied ? <CheckCircle2 className="size-4" /> : <Share className="size-4" />}
                </button>
             </div>
             ...
             <div className="space-y-10 relative z-10">
                ...
                <div className="space-y-3 pt-8 border-t border-border/40">
                   ...
                   <div className={cn("text-4xl font-mono font-bold tabular-nums tracking-tighter", 
          ...
          <div className="surface-card p-8 bg-secondary/5 border-border/30">
