...
import { TrendingUp, Navigation, MapPin, Monitor, RotateCcw, Play, Square, Activity, Info, AlertCircle } from "lucide-react";
...
const SkiSpeedometer = ({ guideHtml, faqs, relatedArticles }: { guideHtml?: string; faqs?: any[]; relatedArticles?: any[] }) => {
  const calc = useMemo(() => CALCULATORS.find(c => c.slug === "ski-snowboard-speed-tracker"), []);
  if (!calc) return null;
      ...
      <div className="grid lg:grid-cols-12 gap-8 items-start max-w-6xl mx-auto">
        ...
        <div className={cn("lg:col-span-8 space-y-8 order-1 lg:order-2", hudMode && "rotate-x-180 scale-x-[-1] opacity-90 brightness-150")}>
          <div className="surface-card p-6 md:p-12 bg-secondary/5 border-border/40 relative overflow-hidden shadow-sm flex flex-col items-center justify-between min-h-[500px] md:min-h-[600px] rounded-3xl">
            ...
            <div className="relative z-10 flex flex-col items-center gap-2">
              <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.3em] text-muted-foreground">
                ...
                {isTracking ? "Downhill Tracking Active" : "Ski & Snowboard Tracker"}
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              { label: "Altitude", value: altitude ? Math.round(altitude) : "---", unit: "m", icon: Activity, color: "text-blue-500" },
          ...
          <div className="surface-card p-6 border-border/30 bg-background rounded-2xl shadow-sm">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h4 className="text-[10px] font-bold uppercase tracking-widest">Alpine Tracking Info</h4>
            </div>
            <p className="text-xs text-muted-foreground leading-relaxed">Record your downhill runs with mountain-ready GPS tracking. Monitor your peak velocity and altitude as you shred the slopes. For best results, keep your phone in an outer jacket pocket with a clear view of the sky.</p>
          </div>
        </div>
        ...
        <div className="lg:col-span-4 space-y-6 order-2 lg:order-1">
          <div className="surface-card p-6 md:p-8 space-y-8 bg-secondary/5 border-border/40 relative overflow-hidden group">
            <TrendingUp className="absolute -bottom-6 -left-6 size-32 text-muted-foreground/5 -rotate-12 transition-transform group-hover:rotate-0 duration-700" />
            ...
            <div className="flex gap-4 items-start relative z-10">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs leading-relaxed font-medium">
                  Keep your device in an outer pocket for optimal GPS reception. Signal strength can vary on steep terrain.
                </p>
              </div>
            </div>
          </div>
