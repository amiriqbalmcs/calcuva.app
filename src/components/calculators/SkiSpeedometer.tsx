  ...
  return (
    <CalculatorPage calc={calc} guideHtml={guideHtml} faqs={faqs} relatedArticles={relatedArticles}>
      <div className={cn("max-w-6xl mx-auto space-y-8 transition-all duration-500", hudMode && "rotate-x-180 scale-x-[-1] opacity-90 brightness-150")}>
        ...
        <div className="surface-card p-6 border-border/30 bg-background rounded-2xl shadow-sm"><div className="flex items-center gap-3"><Info className="size-4 text-muted-foreground" /><h4 className="text-[10px] font-bold uppercase tracking-widest">Alpine Tracking Info</h4></div><p className="text-xs text-muted-foreground leading-relaxed">Record your downhill runs with mountain-ready GPS tracking. Monitor your peak velocity and altitude as you shred the slopes. For best results, keep your phone in an outer jacket pocket with a clear view of the sky.</p></div>
      </div>
    </CalculatorPage>
  );
};
