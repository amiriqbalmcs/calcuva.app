    ...
    <CalculatorPage calc={calc} guideHtml={guideHtml} faqs={faqs} relatedArticles={relatedArticles}>
      <div className="w-full max-w-7xl mx-auto space-y-12 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          ...
          {/* Left Column: Board Selection & Input */}
        ...
        <div id="how-to-use" className="space-y-12">
          {calc.howTo && (
            <div className="pt-8 border-t border-border/40">
              <div className="mb-6">
                <h3 className="text-lg font-bold tracking-tight">How to Calculate Board Percentage</h3>
                <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-bold opacity-60">Instructions & Guidelines</p>
              </div>
              <HowToGuide 
