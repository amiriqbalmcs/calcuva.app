      ...
      <div className="grid lg:grid-cols-12 gap-8 items-start max-w-6xl mx-auto">
        ...
        <div className="lg:col-span-4 space-y-6">
           ...
           <div className="space-y-4 relative z-10">
              <div className="surface-card p-8 bg-health/5 border-health/20 shadow-lg shadow-health/5 space-y-2 transition-all hover:scale-[1.02] border-2">
                 <div className="flex items-center justify-between">
                    <span className="text-[10px] font-black uppercase tracking-widest text-health/70">Daily Generation</span>
                    <Sun className="size-5 text-health" />
                 </div>
                 <p className="text-4xl font-mono font-black text-health leading-none">
              ...
              <div className="surface-card p-8 bg-signal/5 border-signal/20 shadow-lg shadow-signal/5 space-y-2 transition-all hover:scale-[1.02] border-2">
                 <div className="flex items-center justify-between">
                 ...
                 <p className="text-4xl font-mono font-black text-signal leading-none">
              ...
              <div className="surface-card p-8 bg-amber-50/80 border-amber-200 shadow-lg shadow-amber-500/5 space-y-2 transition-all hover:scale-[1.02] border-2">
                 <div className="flex items-center justify-between">
                    <span className="text-[10px] font-black uppercase tracking-widest text-amber-700">PV Panel Estimate</span>
                    <div className="size-5 rounded-full bg-amber-600/10 flex items-center justify-center border border-amber-600/20">
                       <div className="size-1.5 rounded-full bg-amber-600 animate-pulse" />
                    </div>
                 </div>
                 <p className="text-4xl font-mono font-black text-amber-600 leading-none">
