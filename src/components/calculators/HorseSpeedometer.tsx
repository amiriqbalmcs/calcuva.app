  ...
  return (
    <CalculatorPage calc={calc} guideHtml={guideHtml} faqs={faqs} relatedArticles={relatedArticles}>
      <div className={cn("max-w-6xl mx-auto space-y-8 transition-all duration-500", hudMode && "rotate-x-180 scale-x-[-1] opacity-90 brightness-150")}>
        ...
        <div className="surface-card p-6 border-border/30 bg-background rounded-2xl shadow-sm"><div className="flex items-center gap-3"><Info className="size-4 text-muted-foreground" /><h4 className="text-[10px] font-bold uppercase tracking-widest">Equestrian Tracking</h4></div><p className="text-xs text-muted-foreground leading-relaxed">Monitor your horse's velocity and trail performance with precision. Track real-time speed in Trot, Canter, or Gallop and record your total riding distance. Keep your phone in a secure saddlebag or pocket with GPS enabled.</p></div>
      </div>
    </CalculatorPage>
  );
};
