  ...
  return (
    <CalculatorPage calc={calc} guideHtml={guideHtml} faqs={faqs} relatedArticles={relatedArticles}>
      <div className="w-full max-w-7xl mx-auto space-y-12 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="surface-card p-6 border-border/40 bg-background rounded-2xl shadow-sm relative overflow-hidden group">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2 items-start mt-4 pt-4 border-t border-border/10">
                  <Activity className="size-3 text-signal shrink-0 mt-0.5" />
                  <p className="text-[10px] text-muted-foreground leading-relaxed italic">
                    Lower latency peripherals and a high refresh rate screen will yield more accurate results.
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* Full-width How-To Section */}
        {calc.howTo && (
          <div className="pt-8 border-t border-border/40">
            <div className="mb-6">
              <h3 className="text-lg font-bold tracking-tight">How to Test Your Reaction Time</h3>
