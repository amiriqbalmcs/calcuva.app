          ...
          <Tabs defaultValue="whatsapp" className="w-full">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
              ...
              <TabsList className="bg-secondary/50 p-1 rounded-xl">
                ...
                <TabsTrigger value="facebook" className="data-[state=active]:bg-background rounded-lg px-3 py-1.5"><Facebook className="size-3.5 mr-2 text-blue-600" /> Facebook</TabsTrigger>
                <TabsTrigger value="twitter" className="data-[state=active]:bg-background rounded-lg px-3 py-1.5"><Twitter className="size-3.5 mr-2 text-sky-400" /> X / Twitter</TabsTrigger>
              </TabsList>
            </div>
