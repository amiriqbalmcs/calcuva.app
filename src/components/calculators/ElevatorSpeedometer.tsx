  ...
  return (
    <CalculatorPage calc={calc} guideHtml={guideHtml} faqs={faqs} relatedArticles={relatedArticles}>
      <div className={cn("max-w-6xl mx-auto space-y-8 transition-all duration-500", hudMode && "rotate-x-180 scale-x-[-1] opacity-90 brightness-150")}>
        ...
        <div className="surface-card p-6 border-border/30 bg-background rounded-2xl shadow-sm"><div className="flex items-center gap-3"><Info className="size-4 text-muted-foreground" /><h4 className="text-[10px] font-bold uppercase tracking-widest">Elevator Velocity Tracking</h4></div><p className="text-xs text-muted-foreground leading-relaxed">Measure the vertical speed of any elevator in Feet per Minute (FPM) or MPH. This tool also tracks the physical G-forces during acceleration and braking, providing a complete performance profile of high-speed skyscraper lifts.</p></div>
      </div>
    </CalculatorPage>
  );
};
