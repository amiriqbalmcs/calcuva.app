  ...
  return (
    <CalculatorPage calc={calc} guideHtml={guideHtml} faqs={faqs} relatedArticles={relatedArticles}>
      <div className={cn("max-w-6xl mx-auto space-y-8 transition-all duration-500", hudMode && "rotate-x-180 scale-x-[-1] opacity-90 brightness-150")}>
        ...
        <div className="surface-card p-6 border-border/30 bg-background rounded-2xl shadow-sm"><div className="flex items-center gap-3"><Info className="size-4 text-muted-foreground" /><h4 className="text-[10px] font-bold uppercase tracking-widest">Running Analytics</h4></div><p className="text-xs text-muted-foreground leading-relaxed">Track your running performance with high-fidelity GPS data. Monitor your sprint speed, average pace, and total distance covered. Ideal for outdoor training, track sessions, or casual jogging.</p></div>
      </div>
    </CalculatorPage>
  );
};
