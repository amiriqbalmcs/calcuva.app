...
import {
  ...
  Settings2, Shield, Zap, Sparkles, Check, QrCode, Smartphone, Camera, Target,
  Upload, ShieldCheck, FileCode, Info,
  Square as SquareIcon, Grid, Circle, Hexagon, Droplets, Layout
} from "lucide-react";
...
const LOGO_PRESETS = [
  ...
  { id: "whatsapp", label: "Chat", src: "data:image/svg+xml;base64," },
  ...
  { id: "send", label: "Send", src: "data:image/svg+xml;base64," },
  ...
  { id: "video", label: "Video", src: "data:image/svg+xml;base64," },
...
const PRESETS = [
  { id: "whatsapp-pro", label: "WhatsApp Pro", config: { fgColor: "#25d366", gradientColor: "#128c7e", dotStyle: "rounded", eyeStyle: "rounded", pattern: "dots", holographic: true } },
...
const WhatsappQrCodeGenerator = ({ guideHtml, faqs, relatedArticles }: { guideHtml?: string; faqs?: any[]; relatedArticles?: any[] }) => {
  ...
  const [logo, setLogo] = useState("whatsapp");
  ...
  const [frameText, setFrameText] = useState('Message Us');
  ...
  const handleDownload = async (format: 'png' | 'svg' | 'jpeg') => {
    ...
    try {
      if (format === 'svg') {
        ...
        link.download = `whatsapp-qr-${cleanPhone || 'chat'}.svg`;
        link.click();
      } else {
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      if (navigator.share && navigator.canShare({ files: [file] })) {
        await navigator.share({ files: [file], title: 'WhatsApp QR', text: 'Scan to message' });
      }
    } catch {}
  };
      ...
      <div className="grid lg:grid-cols-12 gap-8 items-start max-w-6xl mx-auto">
        ...
        <div className="lg:col-span-4 space-y-6 order-2 lg:order-1">
          <div className="surface-card p-6 md:p-8 space-y-8 bg-secondary/5 border-border/40 relative overflow-hidden group shadow-sm">
            ...
            <div className="space-y-6 relative z-10">
              <div className="space-y-1">
                <h3 className="text-sm font-bold tracking-tight">1. WhatsApp Link</h3>
          ...
          <div className="surface-card p-5 border-emerald-500/20 bg-emerald-500/5 text-emerald-600 relative overflow-hidden group shadow-sm">
            <div className="flex gap-4 items-center relative z-10">
              ...
              <div className="space-y-0.5">
                <h4 className="text-[10px] font-bold uppercase tracking-widest">Secure Chat</h4>
                <p className="text-[9px] font-medium leading-relaxed opacity-80">
                  Links are generated using official wa.me protocols.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-8 space-y-8 min-w-0 order-1 lg:order-2">
                ...
                {frame === 'badge' && (
                  <div className="absolute bottom-10 left-0 right-0 flex flex-col items-center gap-1.5 animate-in fade-in slide-in-from-bottom-2 duration-700">
                    <div className="size-8 rounded-full bg-white shadow-sm flex items-center justify-center mb-1">
                      <MessageSquare className="size-4" style={{ color: fgColor }} />
                    </div>
            ...
            <div className="flex flex-col gap-3 w-full max-w-lg relative z-10">
              ...
              <div className="flex gap-2">
                <button onClick={handleCopyLink} className="flex-1 bg-background border border-border/60 h-11 min-h-[48px] rounded-2xl font-bold uppercase tracking-widest text-[11px] flex items-center justify-center gap-2 hover:bg-secondary transition-all active:scale-95">
                  {copied ? <><Check className="size-4 text-emerald-500" /> Copied</> : <><LinkIcon className="size-4" /> Copy Link</>}
                </button>
          ...
          <div className="surface-card p-6 border-border/20 bg-secondary/10 flex gap-5 items-start">
            ...
            <div className="space-y-2">
              <h4 className="text-[10px] font-bold uppercase tracking-wider">Business Messaging</h4>
              <p className="text-xs text-muted-foreground leading-relaxed">
                WhatsApp QR codes are essential for businesses to bridge the gap between offline and online. Customers can instantly message you for support, sales, or inquiries by scanning the code on your physical storefront or products.
              </p>
            </div>
          </div>
        </div>
