                ...
                <div className="flex justify-between items-start mb-8">
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground">
                      ...
                      {mode === "add" ? "Calculated Future Date" : "Calculated Past Date"}
                    </div>
                ...
                <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-border/40">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="text-3xl md:text-4xl font-mono font-bold text-foreground tabular-nums">
                      {amount} <span className="text-[10px] opacity-40 uppercase tracking-widest font-sans font-bold">Days</span>
                    </div>
                  </div>
                </div>
              </div>
