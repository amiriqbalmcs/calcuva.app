            ...
            <div className="surface-card p-8 md:p-10 space-y-8 bg-background border-border/60 shadow-md relative overflow-hidden group">
              ...
              <div className="space-y-4 relative z-10">
                <div className="flex justify-between items-start">
                  <div className="space-y-1">
                    <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground">Your Age Today</span>
                    <div className="flex flex-wrap items-baseline gap-x-8 gap-y-2 pt-4">
                      <div className="flex items-baseline gap-2">
                        <span className="text-6xl md:text-7xl font-mono font-medium tracking-tighter tabular-nums">{result.years}</span>
                        <span className="text-xs font-bold text-muted-foreground uppercase tracking-widest opacity-40">Years</span>
                      </div>
                      <div className="flex items-baseline gap-2">
                        <span className="text-4xl md:text-5xl font-mono font-medium tracking-tighter tabular-nums">{result.months}</span>
                        <span className="text-xs font-bold text-muted-foreground uppercase tracking-widest opacity-40">Months</span>
                      </div>
                      <div className="flex items-baseline gap-2">
                        <span className="text-4xl md:text-5xl font-mono font-medium tracking-tighter tabular-nums">{result.days}</span>
                ...
                <div className="flex flex-wrap items-center gap-6 pt-8 border-t border-border/40">
                  <div className="flex items-center gap-1.5 px-4 py-1.5 bg-foreground text-background rounded-lg text-[10px] font-bold uppercase tracking-tight shadow-md">
                    ...
                    <span>Next Birthday: {result.daysToBday} Days Left</span>
                  </div>
                  <div className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">
                    Total Time: {formatNumber(result.totalDays)} Days since birth
                  </div>
                </div>
              </div>
            </div>
