  ...
  return (
    <CalculatorPage calc={calc} guideHtml={guideHtml} faqs={faqs} relatedArticles={relatedArticles}>
      <div className={cn("max-w-6xl mx-auto space-y-8 transition-all duration-500", hudMode && "rotate-x-180 scale-x-[-1] opacity-90 brightness-150")}>
        ...
        <div className="surface-card p-6 border-border/30 bg-background rounded-2xl shadow-sm"><div className="flex items-center gap-3"><Info className="size-4 text-muted-foreground" /><h4 className="text-[10px] font-bold uppercase tracking-widest">Cycling Speed Info</h4></div><p className="text-xs text-muted-foreground leading-relaxed">Turn your phone into a professional bike computer. Track your real-time velocity, distance, and average speed using high-precision GPS. Perfect for cycling, mountain biking, or casual city rides.</p></div>
      </div>
    </CalculatorPage>
  );
};
