...
import {
  QrCode, Download, Link as LinkIcon,
  Copy, Check, Activity,
  Settings2, Camera,
  Mail, Upload, ShieldCheck, FileCode, Layers, Info, Zap,
  Smartphone, Phone, MessageSquare,
  Sparkles, Grid, Circle,
...
const LOGO_PRESETS = [
  ...
  { id: "link", label: "Link", src: "data:image/svg+xml;base64," },
  ...
  { id: "qr", label: "QR", src: "data:image/svg+xml;base64," },
  { id: "star", label: "Star", src: "data:image/svg+xml;base64," },
  { id: "camera", label: "Lens", src: "data:image/svg+xml;base64," },
];
...
const PRESETS = [
  { id: "standard", label: "Classic", config: { fgColor: "#000000", gradientColor: "#333333", dotStyle: "square", eyeStyle: "square", pattern: "none", holographic: false } },
...
const QrCodeGenerator = ({ guideHtml, faqs, relatedArticles }: { guideHtml?: string; faqs?: any[]; relatedArticles?: any[] }) => {
  ...
  const [contentType, setContentType] = useState<'url'|'text'|'email'|'phone'|'sms'>('url');
  ...
  const handleShorten = async () => {
    ...
    setShortening(true);
    try {
      const res = await fetch(`https://is.gd/create.php?format=json&url=${encodeURIComponent(content)}`);
      const data = await res.json();
      if (data.shorturl) setContent(data.shorturl);
    } catch {}
    setShortening(false);
  };
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      const file = new File([blob], 'calcuva-qr.png', { type: 'image/png' });
      if (navigator.share && navigator.canShare({ files: [file] })) {
        await navigator.share({ files: [file], title: 'QR Code', text: 'Generated with Calcuva' });
      } else {
  ...
  const densityBarColor = density < 100 ? "bg-emerald-500" : density < 300 ? "bg-amber-500" : "bg-rose-500";
  ...
  return (
    <CalculatorPage calc={calc} guideHtml={guideHtml} faqs={faqs} relatedArticles={relatedArticles}>
      <div className="grid lg:grid-cols-12 gap-8 items-start max-w-6xl mx-auto">
          ...
          <div className="surface-card p-6 md:p-8 space-y-8 bg-secondary/5 border-border/40 relative overflow-hidden group shadow-sm">
            ...
            <div className="space-y-4 relative z-10">
              <div className="flex justify-between items-end">
                <div className="space-y-1">
                  <h3 className="text-sm font-bold tracking-tight">1. Content</h3>
                  <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-medium">Data Payload</p>
                </div>
                <div className="text-right">
                  <p className={cn("text-[10px] font-bold uppercase tracking-tighter", densityColor)}>Density: {densityStatus}</p>
                  <p className="text-[9px] text-muted-foreground font-mono">{density} chars</p>
                </div>
              </div>
              ...
              <div className="flex gap-1.5 flex-wrap">
                {([
                  ...
                  { id: 'text', label: 'Text', icon: Settings2 },
                  ...
                  <button
                    ...
                    onClick={() => {
                      setContentType(t.id);
                      if (t.id === 'url') setContent('https://');
                      else if (t.id === 'email') setContent('mailto:');
                      else if (t.id === 'phone') setContent('tel:+');
                      else if (t.id === 'sms') setContent('sms:+');
                      else setContent('');
                    }}
                    className={cn(
                      "flex items-center gap-1 px-2.5 py-1.5 rounded-lg border text-[9px] font-bold uppercase transition-all",
                      contentType === t.id ? "bg-foreground text-background border-foreground" : "bg-background border-border/60 text-muted-foreground hover:border-foreground/30"
                    )}
                  >
                    <t.icon className="size-2.5" />{t.label}
                  </button>
                ))}
              </div>
              ...
              {contentType === 'text' ? (
                <textarea
                  ...
                  rows={4}
                  className="w-full bg-background border border-border/60 focus:border-foreground/20 font-mono text-sm rounded-xl shadow-sm p-3 resize-none outline-none"
                ...
                <Input
                  ...
                  placeholder={
                    ...
                    contentType === 'email' ? 'mailto:you@example.com' :
                    contentType === 'phone' ? 'tel:+1234567890' :
                    'sms:+1234567890'
                  }
                />
              )}
            ...
            <div className="space-y-6 relative z-10 pt-4 border-t border-border/40">
                ...
                <TabsContent value="colors" className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-[8px] text-muted-foreground/50 font-bold uppercase">
                      <span>160px</span><span>Small</span><span>Medium</span><span>Large</span><span>400px</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      <Label className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Payload Density</Label>
                      <span className={cn("text-[9px] font-bold uppercase", densityColor)}>{densityStatus} · {density} chars</span>
                    </div>
                    <div className="h-1.5 bg-border/40 rounded-full overflow-hidden">
                      <div className={cn("h-full rounded-full transition-all duration-500", densityBarColor)} style={{ width: `${densityPct}%` }} />
                    </div>
                  </div>
                ...
                <TabsContent value="frames" className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <button onClick={() => fileInputRef.current?.click()} className="text-[9px] font-bold uppercase text-finance hover:text-finance/80"><Upload className="size-3 inline mr-1" /> Custom</button>
                    </div>
                    <input type="file" ref={fileInputRef} onChange={handleLogoUpload} className="hidden" accept="image/*" />
                    <div className="flex flex-wrap gap-2">
                      {LOGO_PRESETS.map((p) => (
                        <button key={p.id} onClick={() => { setLogo(p.id); setCustomLogo(null); }} className={cn("size-10 rounded-xl border flex items-center justify-center transition-all", logo === p.id && !customLogo ? "bg-foreground text-background border-foreground shadow-md" : "bg-background border-border/60 hover:border-foreground/20")} title={p.label}>{p.src ? <img src={p.src} alt={p.label} className="size-4" style={{filter: logo === p.id && !customLogo ? "brightness(0) invert(1)" : "brightness(0)"}} /> : <QrCode className="size-4" style={{opacity: logo === p.id && !customLogo ? 1 : 0.6}} />}</button>
                      ))}
                      {customLogo && (
                        <div className="relative">
                          <button onClick={() => setLogo('custom')} className={cn("size-10 rounded-xl border overflow-hidden", logo === 'custom' ? "border-foreground shadow-md ring-2 ring-foreground/20" : "border-border/60")}>
                            <img src={customLogo} alt="Custom" className="size-full object-cover" />
                          </button>
                          <button onClick={() => { setCustomLogo(null); setLogo('none'); }} className="absolute -top-1 -right-1 size-4 bg-rose-500 rounded-full flex items-center justify-center"><X className="size-2.5 text-white" /></button>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {FRAMES.map((f) => (
                        <button key={f.id} onClick={() => setFrame(f.id)} className={cn("h-10 rounded-xl border text-[9px] font-bold uppercase tracking-tight transition-all", frame === f.id ? "bg-foreground text-background border-foreground shadow-md" : "bg-background border-border/60 hover:border-foreground/20")}>{f.label}</button>
                      ))}
                    </div>
                  </div>
              ...
              <div className="flex justify-between items-center pt-2 border-t border-border/20">
                <div className="space-y-1">
                  <Label className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Correction</Label>
                  <p className="text-[8px] text-muted-foreground font-medium">Data redundancy level</p>
                </div>
                <div className="flex bg-background border border-border/60 rounded-lg p-1">
                  {(["L", "M", "Q", "H"] as const).map((l) => (
                    <button key={l} onClick={() => setEcc(l)} className={cn("px-2.5 py-1 text-[9px] font-black rounded-md transition-all", ecc === l ? "bg-foreground text-background" : "text-muted-foreground hover:text-foreground")}>{l}</button>
                  ))}
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-center relative z-10">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-[9px] font-medium leading-relaxed opacity-80">
                  No data leaves your device. Local generation only.
                </p>
              </div>
            </div>
          </div>

          {/* Sidebar Guide (Final Choice) */}
          {calc.howTo && (
            <HowToGuide 
              id="how-to-use"
        ...
        {/* Asset Dashboard (Preview/Results) */}
        <div className="lg:col-span-8 space-y-8 min-w-0 order-1 lg:order-2">
                ...
                {frame === 'badge' && (
                  <div className="absolute bottom-10 left-0 right-0 flex flex-col items-center gap-1.5 animate-in fade-in slide-in-from-bottom-2 duration-700">
                    <div className="size-8 rounded-full bg-white shadow-sm flex items-center justify-center mb-1">
                      <QrCode className="size-4" style={{ color: fgColor }} />
                    </div>
            ...
            <div className="flex flex-col gap-3 w-full max-w-lg relative z-10">
              ...
              <div className="flex gap-2">
                <button onClick={handleCopyLink} className="flex-1 bg-background border border-border/60 h-11 min-h-[48px] rounded-2xl font-bold uppercase tracking-widest text-[11px] flex items-center justify-center gap-2 hover:bg-secondary transition-all active:scale-95">
                  {copied ? <><Check className="size-4 text-emerald-500" /> Copied</> : <><Copy className="size-4" /> Copy</>}
                </button>
                {contentType === 'url' && (
                  <button onClick={handleShorten} disabled={shortening || !content.startsWith('http')} className="flex-1 bg-background border border-border/60 h-11 min-h-[48px] rounded-2xl font-bold uppercase tracking-widest text-[11px] flex items-center justify-center gap-2 hover:bg-secondary transition-all disabled:opacity-40">
                    {shortening ? <Activity className="size-4 animate-pulse" /> : <Zap className="size-4" />}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { l: "ECC Level", v: ecc === 'H' ? 'High' : 'Optimal', i: ShieldCheck },
              { l: "Gradient", v: gradientMode ? "Active" : "None", i: Layers },
              { l: "Readability", v: densityStatus, i: Activity }
            ].map((item, idx) => (
              <div key={idx} className="surface-card p-6 border-border/30 bg-background hover:border-foreground/20 transition-all group shadow-sm">
                ...
                <div className="text-lg font-mono font-bold uppercase tabular-nums leading-tight">{item.v}</div>
              </div>
            ))}
          </div>
          ...
          <div className="surface-card p-6 border-border/20 bg-secondary/10 flex gap-5 items-start">
            ...
            <div className="space-y-2">
              <h4 className="text-[10px] font-bold uppercase tracking-wider">Pro Tip: Character Density</h4>
              <p className="text-xs text-muted-foreground leading-relaxed">
                QR codes become more complex (denser) as you add more text. For the best scanning experience on older mobile devices, try to keep your URL short or use a URL shortener. Current density: <strong>{densityStatus}</strong>.
              </p>
            </div>
          </div>
        </div>
