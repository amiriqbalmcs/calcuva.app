...
const LOGO_PRESETS = [
  ...
  { id: "bitcoin", label: "Bitcoin", src: "data:image/svg+xml;base64," },
  { id: "ethereum", label: "Ethereum", src: "data:image/svg+xml;base64," },
  { id: "wallet", label: "Wallet", src: "data:image/svg+xml;base64," },
  { id: "zap", label: "Lightning", src: "data:image/svg+xml;base64," },
...
const PRESETS = [
  { id: "bitcoin-pro", label: "Gold Standard", config: { fgColor: "#f7931a", gradientColor: "#ffab4a", dotStyle: "classy", eyeStyle: "rounded", pattern: "grid", holographic: true } },
...
const CryptoQrCodeGenerator = ({ guideHtml, faqs, relatedArticles }: { guideHtml?: string; faqs?: any[]; relatedArticles?: any[] }) => {
  ...
  const [logo, setLogo] = useState("bitcoin");
  ...
  const [frameText, setFrameText] = useState('Send Crypto');
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      const file = new File([blob], 'crypto-qr.png', { type: 'image/png' });
      if (navigator.share && navigator.canShare({ files: [file] })) {
        await navigator.share({ files: [file], title: 'Crypto Wallet QR', text: 'Scan to send crypto' });
      }
    } catch {}
  };
      ...
      <div className="grid lg:grid-cols-12 gap-8 items-start max-w-6xl mx-auto">
        ...
        <div className="lg:col-span-4 space-y-6 order-2 lg:order-1">
          <div className="surface-card p-6 md:p-8 space-y-8 bg-secondary/5 border-border/40 relative overflow-hidden group shadow-sm">
            ...
            <div className="space-y-6 relative z-10">
              <div className="space-y-1">
                <h3 className="text-sm font-bold tracking-tight">1. Asset Settings</h3>
                <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-medium">Wallet Payload</p>
              </div>

              <div className="space-y-4">
                <div className="space-y-2">
                  <Label className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Cryptocurrency Network</Label>
                ...
                <div className="space-y-2">
                  <Label className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">Public Address</Label>
          ...
          <div className="surface-card p-5 border-emerald-500/20 bg-emerald-500/5 text-emerald-600 relative overflow-hidden group shadow-sm">
            <div className="flex gap-4 items-center relative z-10">
              ...
              <div className="space-y-0.5">
                <h4 className="text-[10px] font-bold uppercase tracking-widest">Secure Export</h4>
                <p className="text-[9px] font-medium leading-relaxed opacity-80">
                  Address is verified against common protocol patterns.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-8 space-y-8 min-w-0 order-1 lg:order-2">
                ...
                {frame === 'badge' && (
                  <div className="absolute bottom-10 left-0 right-0 flex flex-col items-center gap-1.5 animate-in fade-in slide-in-from-bottom-2 duration-700">
                    <div className="size-8 rounded-full bg-white shadow-sm flex items-center justify-center mb-1">
                      <Coins className="size-4" style={{ color: fgColor }} />
                    </div>
            ...
            <div className="flex flex-col gap-3 w-full max-w-lg relative z-10">
              ...
              <div className="flex gap-2">
                <button onClick={handleCopyLink} className="flex-1 bg-background border border-border/60 h-11 min-h-[48px] rounded-2xl font-bold uppercase tracking-widest text-[11px] flex items-center justify-center gap-2 hover:bg-secondary transition-all active:scale-95">
                  {copied ? <><Check className="size-4 text-emerald-500" /> Copied</> : <><LinkIcon className="size-4" /> Copy Address</>}
                </button>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { l: "Network", v: coin.toUpperCase(), i: ArrowRightLeft },
              { l: "Format", v: "Vector SVG", i: FileCode },
              { l: "ECC", v: ecc === 'H' ? 'High' : 'Optimal', i: ShieldCheck },
              { l: "Security", v: "Non-Custodial", i: Target }
            ].map((item, idx) => (
          ...
          <div className="surface-card p-6 border-border/20 bg-secondary/10 flex gap-5 items-start">
            ...
            <div className="space-y-2">
              <h4 className="text-[10px] font-bold uppercase tracking-wider">Asset Safety</h4>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Always double-check the public address before sending funds. QR codes provide a safer way to share addresses without manual entry errors, but verifying the first and last characters of the address is still recommended.
              </p>
            </div>
          </div>
        </div>
