          ...
          <div className="surface-card p-8 md:p-10 space-y-8 bg-background border-border/60 shadow-md relative overflow-hidden group">
            ...
            <div className="space-y-4 relative z-10">
              <div className="flex justify-between items-start">
                <div className="space-y-1">
                  <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground">Financial Recommendation</span>
                  <div className={cn("text-6xl md:text-7xl font-mono font-medium tracking-tighter tabular-nums", 
                    data.finalBuy < data.finalRent ? "text-foreground" : "text-muted-foreground/60"
                  )}>
              ...
              <div className="flex flex-wrap items-center gap-6 pt-6 border-t border-border/40">
                <div className="flex items-center gap-1.5 px-4 py-1.5 bg-foreground text-background rounded-lg text-[10px] font-bold uppercase tracking-tight">
                  ...
                  <span>Est. EMI: {formatCurrency(data.emi, currency.code)}</span>
                </div>
                <div className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">
                  Break-Even Horizon: {data.breakEven ? `Year ${data.breakEven}` : "Not reached"}
                </div>
              </div>
            </div>
          </div>
