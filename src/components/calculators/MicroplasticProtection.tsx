    ...
    <CalculatorPage calc={calc} guideHtml={guideHtml} faqs={faqs} relatedArticles={relatedArticles}>
      <div className="grid lg:grid-cols-12 gap-8 items-start max-w-6xl mx-auto">
        <div className="lg:col-span-8 space-y-6">
          <div className="surface-card bg-indigo-500/5 dark:bg-indigo-500/10 border-indigo-500/20 overflow-hidden shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative group">
                    <Input
                      ...
                      className="h-20 bg-background border-border/60 font-mono text-4xl font-bold rounded-3xl pl-12 focus:ring-4 ring-indigo-500/5 transition-all"
                      placeholder="5"
                    />
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="surface-card p-10 bg-background border-border/60 shadow-xl space-y-10 sticky top-28 overflow-hidden">
             ...
             <div className="space-y-6 relative border-b border-border/40 pb-10">
                ...
                <div className="text-6xl font-mono font-bold tracking-tighter text-indigo-700">
                   {results.particlesSaved > 1000000 ? (results.particlesSaved / 1000000).toFixed(1) + "M" : results.particlesSaved.toLocaleString()}
                </div>
                <div className="flex items-center gap-2">
                  <div className="px-3 py-1 rounded-full bg-indigo-100 text-indigo-700 text-[10px] font-black uppercase tracking-widest flex items-center gap-2">
             ...
             <div className="space-y-8 relative">
                <div className="p-6 rounded-3xl bg-indigo-50/50 border border-indigo-100 space-y-4">
                   <div className="flex items-center gap-2 text-indigo-700/60">
                      <Wind className="size-4" />
                      <span className="text-[10px] font-black uppercase tracking-[0.2em]">Eco Protection</span>
                   </div>
                   <div className="space-y-4">
                      <div className="space-y-1.5">
                        <div className="flex justify-between text-[9px] font-bold uppercase text-indigo-800">
