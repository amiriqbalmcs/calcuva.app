      ...
      <div className={cn("max-w-6xl mx-auto grid lg:grid-cols-12 gap-8 items-start transition-all duration-500", hudMode && "rotate-x-180 scale-x-[-1] opacity-90 brightness-150")}>
        ...
        <div className="lg:col-span-8 space-y-8 order-1 lg:order-2">
          ...
          <div className="surface-card p-6 md:p-12 bg-secondary/5 border-border/40 relative overflow-hidden group shadow-sm flex flex-col items-center justify-between min-h-[500px] md:min-h-[600px] rounded-2xl">
            ...
            <div className="relative z-20 flex items-center justify-center gap-2 md:gap-8 w-full border-t border-border/10 pt-8">
              ...
              <button onClick={resetStats} className="h-10 md:h-12 px-3 md:px-6 rounded-xl border border-border/60 bg-background text-muted-foreground flex items-center gap-2 font-bold text-[10px] uppercase tracking-widest transition-all hover:bg-secondary">
        ...
        <div className="lg:col-span-4 space-y-6 order-2 lg:order-1">
          <div className="surface-card p-6 md:p-8 space-y-8 bg-secondary/5 border-border/40 relative overflow-hidden group">
            <context.icon className="absolute -bottom-6 -left-6 size-32 text-muted-foreground/5 -rotate-12 transition-transform group-hover:rotate-0 duration-700" />

            <div className="space-y-1 relative z-10">
              <h3 className="text-sm font-bold tracking-tight">Tracking Settings</h3>
              <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-medium">Configure Display</p>
            </div>
          ...
          <div className="surface-card p-6 border-signal/20 bg-signal/[0.03] text-signal relative overflow-hidden group">
            <Info className="absolute -bottom-4 -right-4 size-20 opacity-10 group-hover:rotate-12 transition-transform duration-700" />
            <div className="flex gap-4 items-start relative z-10">
              <div className="mt-1">
                <Info className="size-5" />
              </div>
              <div className="space-y-1">
                <h4 className="text-[10px] font-bold uppercase tracking-wider opacity-80">Accuracy Note</h4>
                <p className="text-xs leading-relaxed font-medium">
                  GPS performance is best outdoors. Tall buildings or heavy cover can impact real-time precision.
                </p>
              </div>
            </div>
          </div>
