      ...
      <div className="w-full max-w-7xl mx-auto space-y-12 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-4 space-y-6 order-1 lg:order-2">
            <div className="surface-card p-8 md:p-10 space-y-10 bg-background border-border/60 shadow-md relative overflow-hidden group sticky top-32">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-8 pt-8 border-t border-border/40">
                  <div className="space-y-1">
                    ...
                    <div className="text-4xl md:text-5xl font-mono font-bold text-foreground tabular-nums">
        ...
        {/* Previous Records Section (Full Width) */}
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="surface-card p-6 border-border/30 bg-finance/5 text-finance relative overflow-hidden group shadow-sm">
              ...
              <div className="flex gap-4 items-start relative z-10">
                <div className="mt-1"><Award className="size-5" /></div>
                <div className="space-y-1">
                  <h4 className="text-[10px] font-bold uppercase tracking-wider text-finance/80">Academic Tip</h4>
                  <p className="text-xs leading-relaxed font-medium">{result.insight}</p>
                </div>
              </div>
            </div>

            <div className="surface-card p-6 border-border/30 space-y-4 bg-secondary/5 relative overflow-hidden group shadow-sm">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed font-medium relative z-10">
                Classes with more credits have a bigger effect on your GPA than small elective classes.
              </p>
            </div>
            ...
            <div className="surface-card p-6 border-border/30 space-y-4 bg-secondary/5 relative overflow-hidden group shadow-sm">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed font-medium relative z-10">
                Use this tool to see what grades you need in future classes to reach your goal GPA.
              </p>
            </div>
          </div>
        </div>
        ...
        {calc.howTo && (
          <div id="how-to-use" className="pt-8 border-t border-border/40">
            <div className="mb-6">
              <h3 className="text-lg font-bold tracking-tight">How to Calculate GPA to Percentage</h3>
