        ...
        <div className={cn("lg:col-span-8 space-y-8 order-1 lg:order-2", hudMode && "rotate-x-180 scale-x-[-1] opacity-90 brightness-150")}>
          ...
          <div className="surface-card p-6 border-border/30 bg-background rounded-2xl shadow-sm">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h4 className="text-[10px] font-bold uppercase tracking-widest">Coaster Ride Telemetry</h4>
            </div>
            <p className="text-xs text-muted-foreground leading-relaxed">This specialized tracker measures both your GPS velocity and the physical G-forces during a roller coaster ride. For best results, keep your phone secure in a zipped pocket or hold it firmly to record peak intensity.</p>
          </div>
        </div>
        ...
        <div className="lg:col-span-4 space-y-6 order-2 lg:order-1">
          <div className="surface-card p-6 md:p-8 space-y-8 bg-secondary/5 border-border/40 relative overflow-hidden group">
            ...
            <div className="space-y-1 relative z-10">
              <h3 className="text-sm font-bold tracking-tight">Telemetry Settings</h3>
            ...
            <div className="flex gap-4 items-start relative z-10">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs leading-relaxed font-medium">
                  Ensure GPS is enabled. Peak G-forces are most accurate when the device is oriented correctly.
                </p>
              </div>
            </div>
          </div>
