              ...
              <div className="flex justify-between items-start mb-8">
                <div className="space-y-2">
                  ...
                  <div className={cn(
                    ...
                    result.margin >= 25 ? "text-health" : result.margin > 0 ? "text-amber-500" : "text-destructive"
                  )}>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-border/40">
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-3xl md:text-4xl font-mono font-bold text-foreground tabular-nums">
                    {result.markup.toFixed(1)}% <span className="text-[10px] opacity-40 uppercase tracking-widest font-sans font-bold">Markup</span>
                  </div>
                </div>
              </div>
            </div>
