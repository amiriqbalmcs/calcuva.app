          ...
          "@graph": [
            {
              "@type": "WebApplication",
              "name": calc.title,
              "applicationCategory": calc.category === "finance" ? "FinanceApplication" : calc.category === "health" ? "HealthApplication" : "UtilitiesApplication",
              "operatingSystem": "Any",
              "description": calc.description,
            ...
            },
            {
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "position": 2,
                  "name": cat.label,
                  "item": `${SITE_URL}/category/${calc.category}`
                },
                {
                  "@type": "ListItem",
                  "position": 3,
                  "name": calc.title,
                  "item": `${SITE_URL}/calculators/${calc.slug}`
                }
              ]
            },
            ...(calc.howTo ? [{
              "@type": "HowTo",
              "name": `How to use ${calc.title}`,
              "step": calc.howTo.steps.map((s, i) => ({
                "@type": "HowToStep",
                "position": i + 1,
                "name": s.title,
                "itemListElement": [{
