        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20">
          ...
          <div className="lg:col-span-4 max-w-sm">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link href="mailto:hello@calcuva.com" className="size-9 rounded-full bg-background border border-border flex items-center justify-center text-muted-foreground hover:text-signal hover:border-signal transition-all shadow-sm" title="Email Us">
